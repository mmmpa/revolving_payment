...
var LoanType;
(function (LoanType) {
    LoanType[LoanType["Revolving"] = 0] = "Revolving";
    LoanType[LoanType["Payday"] = 1] = "Payday";
})(LoanType || (LoanType = {}));
...
var Revolver = (function (_super) {
    ...
    Revolver.prototype.plan = function (nextState, oldState) {
        ...
        var paymentStepper = new RevolvingPayment(total, rate, payment, type).generateStepper();
    ...
    Revolver.prototype.render = function () {
        ...
        })), React.createElement("p", {className: "separator"}, "ずつ返す")), React.createElement("div", {className: "type"}, React.createElement("label", {onClick: function () { return _this.setState({ type: LoanType.Revolving }); }}, " ", React.createElement("input", {type: "radio", checked: this.state.type === LoanType.Revolving}), React.createElement("strong", null, "リボ払い"), React.createElement("p", null, "返済額+手数料=お支払い額"), React.createElement("p", null, "月々の支払額が変動する。")), " ", React.createElement("label", {onClick: function () { return _this.setState({ type: LoanType.Payday }); }}, React.createElement("input", {type: "radio", checked: this.state.type === LoanType.Payday}), React.createElement("strong", null, "消費者金融"), React.createElement("p", null, "お支払い額から手数料が引かれ、残りが返済になる"), React.createElement("p", null, "月々の支払額が変動しない。")))), React.createElement("section", {className: "revolvingResult"}, React.createElement("h1", null, "返済履歴"), React.createElement(PaymentTable, React.__spread({}, { paymentHistory: paymentHistory }))), this.writeButton(), " ", this.writeResult());
    };
    return Revolver;
}(React.Component));
...
var RevolvingPayment = (function () {
    function RevolvingPayment(total, rate, payment, type) {
        if (type === void 0) { type = LoanType.Revolving; }
        this.total = total;
        this.rate = rate;
...
var RevolvingStepper = (function () {
    function RevolvingStepper(configuration, type) {
    ...
    RevolvingStepper.prototype.stepRevolving = function () {
    ...
    RevolvingStepper.prototype.stepPayday = function () {
        var interest = this.getInterest(this.rest - this.payment * 0.5);
